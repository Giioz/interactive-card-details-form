export const CardFront = () => {
  return (
    <div className="bg-[url(./public/icons/card-mobile.svg)] w-[285px] h-[156.21px] absolute z-10 bottom-0 px-[19px] py-[17px] font-grotesk">
      ...
      <div className="w-full mt-[37px] font-medium text-white">
        ...
        <div className="text-[9px] tracking-[1.3px] flex justify-between mt-[17px]">
          <div>
            <p>JANE APPLESEED</p>
          </div>
          <div>
